        ...
        <div class="row">
          ...
          <div class="col-md-4">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('staff.store.reset.password',$token) }}">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control" name="email" tabindex="1" autofocus value="{{ $admin->email }}" readonly>
                  </div>
            ...
            <div class="mt-5 text-muted text-center">
                {{__('admin.Back To Login Page')}}, <a href="{{ route('staff.login') }}">{{__('admin.Click Here')}}</a>
            </div>
