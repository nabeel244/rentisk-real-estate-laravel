                        ...
                        <form action="{{ route('admin.counter.update', $counter->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control"  name="qty" value="{{ $counter->qty }}">
                                </div>

                               <div class="form-group col-12">
                                    <label>{{__('admin.Icon')}} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control custom-icon-picker" autocomplete="off"  name="icon" value="{{ $counter->icon }}">
                                </div>
