...
@section('title')
<title>{{__('admin.Create Staff')}}</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>{{__('admin.Create Staff')}}</h1>
          </div>

          <div class="section-body">
            <a href="{{ route('admin.staff.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('admin.Staff List')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
