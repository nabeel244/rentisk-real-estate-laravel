...
@section('title')
<title>{{__('admin.Create Language')}}</title>
@endsection
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a
                        href="{{ route('admin.languages.index') }}">{{__('admin.Languages')}}</a></div>
                <div class="breadcrumb-item">{{__('admin.Create Language')}}</div>
            </div>
        </div>

        <div class="section-body">
            <a href="{{ route('admin.languages.index') }}" class="btn btn-primary"><i class="fas fa-list"></i>
                {{__('admin.Languages')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
...
<script>
    $(document).ready(function () {
        ...
        codeSelect.find("option").each(function () {
            ...
            newOption.val(option.text());
            nameSelect.append(newOption);
        });
    });

    $('#code').change(function () {
        const selectedCode = $("#code option:selected").text();
        const correspondingOption = $('#name option').filter(function () {
            return $(this).text() === selectedCode;
        });
    ...
    $('#name').change(function () {
        const selectedCode = $("#name option:selected").text();

        const correspondingOption = $('#code option').filter(function () {
            return $(this).text() === selectedCode;
        });
