@extends('user.layout')
@section('title')
    <title>{{__('user.Client Reviews')}}</title>
@endsection
    ...
    <div class="col-xl-9 ms-auto">
        <div class="wsus__dashboard_main_content">
          <div class="wsus__dash_riview">
            <h4 class="heading">{{__('user.Client Reviews')}}</h4>
            <div class="row">
              <div class="col-xl-12">
                    ...
                    @foreach ($clientReviews as $item)
                        <div class="wsus__message_single">
                            <div class="wsus__message_img">
                                <img src="{{ $item->user_image ? url($item->user_image) : url($agent_default_profile) }}" alt="img" class="img-fluid">
                            </div>
                ...
                {{ $clientReviews->links('custom_paginator') }}
