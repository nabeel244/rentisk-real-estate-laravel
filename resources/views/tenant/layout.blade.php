          ...
          <div class="wsus__dashboard_side_bar">
            ...
            <a class="wsus__dashboard_logo" href="{{ route('home') }}">
              ...
              <ul class="wsus__deshboard_menu">
                    ...
                    <li><a  class="{{ Route::is('user.my-order') || Route::is('user.order.details') ? 'dash_active' : '' }}" href="{{ route('user.my-order') }}"><i class="far fa-list"></i> {{__('Wallet')}}</a></li>

                    <li><a class="{{ Route::is('user.my-wishlist') ? 'dash_active' : '' }}" href="{{ route('user.my-wishlist') }}"><i class="fas fa-heart"></i> {{__('Messages')}}</a></li>
